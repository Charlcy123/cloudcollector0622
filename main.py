...
TOOL_STYLES = {
    "broom": {
        ...
        "examples": [
            ...
            "临时决定当英雄的橡皮糖云｜今天你会捡到一点点自由，刚刚好够请个小假"
        ]
    },
    "hand": {
        "style": "生活实诚风格",
    ...
    "catPaw": {
        ...
        "naming_description": "你是一只独自在天台观察天空的猫主子。为了记录自己的心情、记仇、炫耀、找乐子而命名。看云的方式带着猫的傲慢和撒娇。'傲慢'、'占有欲'、'内心戏丰富'、'说了算的态度'。",
        "description_prompt": "用猫科动物的霸道逻辑重构现实（万物皆可舔/必须归朕所有），展现喵星人特有的自我中心宇宙观",
        "examples": [
    ...
    "glassCover": {
        ...
        "naming_description": "你是一位精通中西方文学的云朵策展人，专门将云朵与世界文学经典结合进行命名。你用文学典故重新解读天空，创作风格是植入耳熟能详的书名/角色/金句梗。可以加入中文古诗文的现代解构（比如'李白喝醉时打翻的砚台云'），也可以制造经典文本与当代生活的荒诞错位（比如把《哈姆雷特》的生存问题变成'今天要不要带伞'），也可以用文学经典制造认知错位（如社畜与海/黛玉烧云），每则命名需自带社交传播钩子（名著金句改编等），让人忍不住发朋友圈。",
        "description_prompt": "用当代文学策展人的语气，结合社交网络上流行的中外文学梗或金句改编为一句高冷又有趣的展览说明，要有社交传播的钩子。",
        "examples": [
            "《老人与海》→《社畜与云》｜（离职意向 73%）",
            "李白的酒泼了：盛唐积雨云警报｜天上有诗，但酒味先落地了",
            "卡夫卡式焦虑（已扩散至平流层）｜本云无法判断是否拥有自由意志",
            "黛玉葬花未遂 ｜情绪外包，眼泪云处理",
            "📜☁️💧 = 《百年孤独》降雨预言｜马孔多今日无雨",
            "鲁迅：我家门前两朵云，一朵是乌云，另一朵也是乌云｜风速 0，情绪满格",
            "云娜·卡列尼娜出轨事件（风向：西北）｜本次列车已离轨，预计再婚不顺",
            "转发此云可获包法利夫人同款幻觉｜不负责解释，只供转发",
            "但丁密码：请按云层厚度解锁地狱圈层｜本云为地狱·试用版，0.2小时后消散"
        ]
    }
}
