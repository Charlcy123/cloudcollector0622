...
export default function TestFont() {
  return (
    <div className="min-h-screen p-8 bg-white">
      <h1 className="text-4xl font-bold mb-8 text-center">字体测试页面</h1>
      
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="p-6 border rounded-lg">
          <h2 className="text-2xl font-bold mb-4">手札体测试</h2>
          <p className="text-lg mb-4">
            这是一段测试文字，用来检验手札体是否正确加载。
          </p>
        ...
        <div className="p-6 border rounded-lg">
          ...
          <div className="space-y-2">
            <p className="font-normal">正常字重: 手札体测试文字</p>
            <p className="font-bold">粗体字重: 手札体测试文字</p>
            <p className="font-light">细体字重: 手札体测试文字</p>
          </div>
        </div>
      </div>
